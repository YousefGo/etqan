    ...
    <footer class="bluelight text-center text-white mt">
        ...
        <div class="container p-4 pb-0 ">
            <div class="row">
                ...
                <!-- Twitter -->
                <div class="col-2">
                    <a class="btn btn-outline-light btn-floating  " href="https://twitter.com/itqan_2021 " target="_blank" role="button"><i class="fab fa-twitter"></i></a>

                </div>

                <div class="col-2">
                    <!-- Linkedin -->
                    <a class="btn btn-outline-light btn-floating  " href="http://linkedin.com/in/منصة-اتقان-b932a5208"   target="_blank" role="button"><i class="fab fa-linkedin-in"></i></a>
                </div>
